                                ...
                                <table class="table table-hover table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="assets/admin/images/products/img-1.png" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="assets/admin/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="assets/admin/images/products/img-3.png" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="assets/admin/images/products/img-4.png" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-sm bg-light rounded p-1 me-2">
                                                    <img src="assets/admin/images/products/img-5.png" alt="" class="img-fluid d-block" />
                                                </div>
                                                <div>
                                ...
                                <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/companies/img-1.png" alt="" class="avatar-sm p-2" />
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/companies/img-2.png" alt="" class="avatar-sm p-2" />
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/companies/img-3.png" alt="" class="avatar-sm p-2" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/companies/img-8.png" alt="" class="avatar-sm p-2" />
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/companies/img-5.png" alt="" class="avatar-sm p-2" />
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h5 class="fs-14 my-1 fw-medium">
                                ...
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 me-2">
                                                    <img src="assets/admin/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle" />
                                                </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                        <div class="acitivity-timeline acitivity-main">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                        <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                            <img src="assets/admin/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                        </a>
                                        <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                            <img src="assets/admin/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                        </a>
                                        <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                            <img src="assets/admin/images/products/img-10.png" alt="" class="img-fluid d-block" />
                                        </a>
                                    </div>
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                <div class="flex-shrink-0">
                                    <img src="assets/admin/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="acitivity-item d-flex">
                                <div class="flex-shrink-0">
                                    <img src="assets/admin/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                ...
                                <div class="swiper-slide">
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/admin/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="assets/admin/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
