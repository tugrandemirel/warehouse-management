    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.warehouse.update', ['warehouse' => $warehouse]) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="firstNameinput" class="form-label">Depo Adı</label>
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $warehouse->name }}" placeholder="Depo Adı" id="firstNameinput">
                                </div>
                                @error('name')
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $warehouse->description }}</textarea>
                                </div>
