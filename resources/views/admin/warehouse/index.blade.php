...
{{--                                <button type="button" class="btn btn-info" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-filter-3-line align-bottom me-1"></i> Fliters</button>--}}
                                <a href="{{ route('admin.warehouse.create') }}" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i> Depo Ekle</a>
                        ...
                        <div class="table-responsive table-card">
                            ...
                            <table class="table align-middle" id="customerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="email">Depo Sahibi</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 ms-2 name">{{ $warehouse->name }}</div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2 name">{{ $warehouse->user->name }}</div>
                                            </div>
                                        </td>
                                        <td class="email">
                                            <a href="mailto:{{ $warehouse->user->email }}">{{ $warehouse->user->email }}</a>
                                        </td>
                                        <td class="phone">
                                            <a href="tel:{{ $warehouse->user->phone }}">{{ $warehouse->user->phone ?? '-'}}</a>
                                        </td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a class="edit-item-btn" href="{{ route('admin.warehouse.edit', ['warehouse' => $warehouse]) }}">
                                                        <i  class="ri-pencil-fill align-bottom text-muted"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                    <a class="remove-item-btn" data-id="{{ $warehouse->id }}">
        ...
        $(document).ready(function () {
            $('.remove-item-btn').click(function () {
                ...
                $('#delete-record').click(function () {
                    let url = "{{ route('admin.warehouse.destroy', ['warehouse' => 'id']) }}";
