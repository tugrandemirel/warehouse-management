    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">FİRMALAR</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">ADMİN</a></li>
                        <li class="breadcrumb-item active">FİRMALAR</li>
                    </ol>
                </div>
...
{{--                                <button type="button" class="btn btn-info" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-filter-3-line align-bottom me-1"></i> Fliters</button>--}}
                                <a href="{{ route('admin.product.create') }}" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i> Firma Ekle</a>
                        ...
                        <div class="table-responsive table-card">
                            ...
                            <table class="table align-middle" id="customerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="image">Firma Logosu</th>
                                    <th class="sort" data-sort="name">Firma Adı</th>
                                ...
                                @foreach($companies as $company)
                                        <tr>
                                            <th scope="row" >
                                                <div class="form-check">
                                                    <input class="form-check-input remove-action" type="checkbox" name="chk_child" value="{{ $company->id }}">
                                                </div>
                                            </th>
                                            <td class="image">
                                            ...
                                            <td class="name">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 ms-2 name">{{ $company->name }}</div>
                                                </div>
                                            </td>
                                            <td class="date">
                                            ...
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                        <a class="edit-item-btn" href="{{ route('admin.company.edit', ['company' => $company]) }}">
                                                            <i  class="ri-pencil-fill align-bottom text-muted"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                        <a class="remove-item-btn" data-id="{{ $company->id }}">
                            ...
                            <div class="noresult" >
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">Lütfen Firma ekleyiniz.</p>
                                </div>
                            </div>
                            @endif
                        </div>
        ...
        $(document).ready(function () {
            $('.remove-item-btn').click(function () {
                ...
                $('#delete-record').click(function () {
                    let url = "{{ route('admin.company.destroy', ['company' => 'id']) }}";
        ...
        function deleteMultiples() {
            ...
            if(allVals.length <= 0) {
                ...
                $('#delete-record').click(function () {
                    ...
                    $.ajax({
                        url: "{{ route('admin.company.deleteMultiple') }}",
                        type: 'DELETE',
                        cache: false,
                        data: {
                            _token: "{{ csrf_token() }}",
