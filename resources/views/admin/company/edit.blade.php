                ...
                <div class="card">
                    <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Firma Adı" value="{{  $company->name }}" required>
                                @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="degree" value="{{ $company->degree  }}" placeholder="Firma Unvanı Giriniz">
                            @error('degree')
                                <div class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="ckeditor-classic">{!!  $company->description !!}</textarea>
                            @error('description')
                                <div class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </div>
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3 states">
                                                    <label class="form-label" id="form-label">Şehir</label>
                                                    <select name="state_id" class="form-select" id="changeState">
                                                        <option value="0">Seçiniz</option>
                                                        @foreach($states as $state)
                                                            <option value="{{ $state->id }}" @if($company->state_id === $state->id) selected @endif>{{ $state->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="address" class="form-control" id="" cols="30" rows="3">{{ $company->address }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="is_active">
                                                        <option value="{{ \App\Enum\Company\CompanyIsActiveEnum::ACTIVE }}" @if($company->is_active === \App\Enum\Company\CompanyIsActiveEnum::ACTIVE ) selected @endif selected>Aktif</option>
                                                        <option value="{{ \App\Enum\Company\CompanyIsActiveEnum::PASSIVE }}" @if($company->is_active === \App\Enum\Company\CompanyIsActiveEnum::PASSIVE ) selected @endif>Pasif</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <div class="text-center">
                                <input class="form-control" name="tax_administration" value="{{ $company->tax_administration }}"  type="text">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-center">
                                <input class="form-control" name="tax_number" value="{{ $company->tax_number }}"  type="text">
                            </div>
                            @error('tax_number')
                            <div class="text-danger">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-center">
                                <input class="form-control" name="room_registration_number" value="{{ $company->room_registration_number }}"  type="text">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="text-center">
                                <input class="form-control" name="website" value="{{ $company->website }}"  type="text">
                            </div>
                            @error('website')
                            <div class="text-danger">
                                <strong>{{ $message }}</strong>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <div class="text-center">
                                <input class="form-control is-numeric" name="phone" value="{{ $company->phone }}"  type="text">
                            </div>
                            @error('phone')
                            <div class="text-danger">
                                <strong>{{ $message }}</strong>
