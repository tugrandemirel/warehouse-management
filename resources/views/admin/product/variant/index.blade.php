...
{{--                                <button type="button" class="btn btn-info" data-bs-toggle="offcanvas" href="#offcanvasExample"><i class="ri-filter-3-line align-bottom me-1"></i> Fliters</button>--}}
                                <a href="{{ route('admin.product.variant.create') }}" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i> Varyant Ekle</a>
                        ...
                        <div class="table-responsive table-card">
                            ...
                            <table class="table align-middle" id="customerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sort" data-sort="name">Varyant Adı</th>
                                    <th class="sort" data-sort="group">Bağlı Olduğu Grup Adı</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="name">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 ms-2 name">{{ $variant->name }}</div>
                                            </div>
                                        </td>
                                        <td class="group">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 ms-2 name">{{ $variant->variantGroup->name }}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                    <a class="edit-item-btn" href="{{ route('admin.product.variant.edit', ['variant' => $variant]) }}">
                                                        <i  class="ri-pencil-fill align-bottom text-muted"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                    <a class="remove-item-btn" data-id="{{ $variant->id }}">
        ...
        $(document).ready(function () {
            $('.remove-item-btn').click(function () {
                ...
                $('#delete-record').click(function () {
                    let url = "{{ route('admin.product.variant.destroy', ['variant' => 'id']) }}";
